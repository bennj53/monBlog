...
@Component({
  selector: 'app-syncfusion-markdown-editor',
  //templateUrl: './syncfusion-markdown-editor.component.html',
...
export class SyncfusionMarkdownEditorComponent {
  ...
  public tools: object = {
      items: ['Bold', 'Italic', 'StrikeThrough', '|', 'Formats', 'OrderedList', 'UnorderedList', '|', 'CreateLink', 'Image', '|',
          {
              tooltipText: 'Preview',
              template: '<button id="preview-code" type="button" class="e-tbar-btn e-control e-btn e-icon-btn">' +
              '<span class="e-btn-icon e-md-preview e-icons"></span></button>'
          }, {
              tooltipText: 'Split Editor',
              template: '<button id="MD_Preview" type="button" class="e-tbar-btn e-control e-btn e-icon-btn">' +
